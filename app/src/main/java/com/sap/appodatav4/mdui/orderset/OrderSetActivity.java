 ...
 * - {@link OrderSetCreateFragment}: to create or edit a(n) Order,
 * - {@link OrderSetDetailFragment}: to display the details of a(n) Order,
 * - {@link OrderSetListFragment}: to list OrderSet.
 *
 ...
 * what to do.
 */
public class OrderSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<Order> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link OrderSetListFragment} is
     * getting instantiated (which will load {@link OrderSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new OrderSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable Order entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        OrderSetCreateFragment fragment = new OrderSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable Order entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new OrderSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new OrderSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable Order entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link OrderSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((OrderSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            OrderViewModel viewModel = new ViewModelProvider(getActivity()).get(OrderViewModel.class);
