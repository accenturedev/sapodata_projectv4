 ...
 * - {@link OrderItemSetCreateFragment}: to create or edit a(n) OrderItem,
 * - {@link OrderItemSetDetailFragment}: to display the details of a(n) OrderItem,
 * - {@link OrderItemSetListFragment}: to list OrderItemSet.
 *
 ...
 * what to do.
 */
public class OrderItemSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<OrderItem> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link OrderItemSetListFragment} is
     * getting instantiated (which will load {@link OrderItemSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new OrderItemSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable OrderItem entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        OrderItemSetCreateFragment fragment = new OrderItemSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable OrderItem entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new OrderItemSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new OrderItemSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable OrderItem entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link OrderItemSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((OrderItemSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            OrderItemViewModel viewModel = new ViewModelProvider(getActivity()).get(OrderItemViewModel.class);
